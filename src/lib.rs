...
#[repr(i32)]
    ...
    unsafe extern "C++"
    {
        ...
        fn EvalCompareSchemeSwitching(
            ...
            pLWE : /* 0 */ u32,
            scaleSign : /* 1.0 */ f64,
            unit : /* false */ bool, ) -> UniquePtr<CiphertextDCRTPoly>;
        ...
        fn MultipartyKeyGenByPublicKey(
            ...
            fresh : /* false */ bool, ) -> UniquePtr<KeyPairDCRTPoly>;
        ...
        fn DCRTPolyGetCopyOfAllEvalAutomorphismKeys() -> UniquePtr<MapFromStringToMapFromIndexToEvalKey>;
    ...
    unsafe extern "C++"
    {
        ...
        fn DCRTTrapdoorGen(
            ...
            stddev : f64,
            base : i64,
            balanced : bool, ) -> UniquePtr<DCRTTrapdoor>;
...
pub fn
parse_coefficients_bytes(bytes : &[u8]) -> ParsedCoefficients
{
    if bytes
        .len() < 14
        {
