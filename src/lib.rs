...
#[repr(i32)]
    ...
    unsafe extern "C++"
    {
        ...
        fn ExtractMatrixRow(matrix : &Matrix, row : usize)
            ->UniquePtr<Matrix>;
        fn ExtractMatrixCol(matrix : &Matrix, col : usize)
            ->UniquePtr<Matrix>;
        fn ExtractMatrixRows(matrix : &Matrix, startRow : usize, endRow : usize)
            ->UniquePtr<Matrix>;
        fn ExtractMatrixCols(matrix : &Matrix, startCol : usize, endCol : usize)
            ->UniquePtr<Matrix>;
